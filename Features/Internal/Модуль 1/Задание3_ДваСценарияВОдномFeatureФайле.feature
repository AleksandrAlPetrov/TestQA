...
Функционал: сценарный тест на проверку расчета суммы документа Заказ при изменении количества и цены и изменении поля количества при при добавлении услуги в документа Заказ
